...
from .views import (indexView, register, register_rol,profile_view, about, contact, edit_profile_view,index_arrendatario,dashboard_arrendador,not_authorized_view,create_inmueble,edit_inmueble,detail_inmueble,delete_inmueble,edit_disponibilidad_inmueble,send_solicitud,view_list_user_solicitudes,view_list_solicitudes,edit_status_solicitud)
